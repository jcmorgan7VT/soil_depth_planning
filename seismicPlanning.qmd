...
#watershed boundary
w3_shed <- paste0(arsenal, "/w3_dems/w3_shed.tif")
...
fahey <- read_csv("https://pasta.lternet.edu/package/data/eml/knb-lter-hbr/121/5/d2a6900ad5470d00dce0d7fa0bca3eec")

ggplot(fahey, aes(x = UTM_EASTING, y = UTM_NORTHING, color = MEAN))+
  geom_point()
