...
wsnb1 <- left_join(
    ...
    zone_in_shed(rast(flowacc3_output), buffer1, "wsnb1_flowacc3"),
    zone_in_shed(rast(flowacc1_output), buffer1, "wsnb1_flowacc1"),
    zone_in_shed(rast(slope10_output), buffer1, "wsnb1_slope10"),
    zone_in_shed(rast(slope5_output), buffer1, "wsnb1_slope5"),
    zone_in_shed(rast(slope3_output), buffer1, "wsnb1_slope3"),
    zone_in_shed(rast(slope1_output), buffer1, "wsnb1_slope1"),
    zone_in_shed(rast(tpi10_output), buffer1, "wsnb1_tpi10"),
    zone_in_shed(rast(tpi5_output), buffer1, "wsnb1_tpi5"),
    zone_in_shed(rast(tpi3_output), buffer1, "wsnb1_tpi3"),
    zone_in_shed(rast(tpi1_output), buffer1, "wsnb1_tpi1"),
    zone_in_shed(rast(twi10_output), buffer1, "wsnb1_twi10"),
    zone_in_shed(rast(twi5_output), buffer1, "wsnb1_twi5"),
    zone_in_shed(rast(twi3_output), buffer1, "wsnb1_twi3"),
    zone_in_shed(rast(twi1_output), buffer1, "wsnb1_twi1"),
    zone_in_shed(curve10_plan, buffer1, "wsnb1_curve10_plan"),
    zone_in_shed(curve10_prof, buffer1, "wsnb1_curve10_prof"),
    zone_in_shed(curve5_plan, buffer1, "wsnb1_curve5_plan"),
    zone_in_shed(curve5_prof, buffer1, "wsnb1_curve5_prof"),
    zone_in_shed(curve3_plan, buffer1, "wsnb1_curve3_plan"),
    zone_in_shed(curve3_prof, buffer1, "wsnb1_curve3_prof"),
    zone_in_shed(curve1_plan, buffer1, "wsnb1_curve1_plan"),
    zone_in_shed(curve1_prof, buffer1, "wsnb1_curve1_prof"),
    zone_in_shed(depth10, buffer1, "wsnb1_depth10"),
    zone_in_shed(depth5, buffer1, "wsnb1_depth5"),
    zone_in_shed(depth3, buffer1, "wsnb1_depth3"),
    zone_in_shed(depth1, buffer1, "wsnb1_depth1")

)
#### Buffer 10 ####
wsnb10 <- bind_cols(
    zone_in_shed(rast(flowacc10_output), buffer10, "wsnb10_flowacc10"),
    zone_in_shed(rast(flowacc5_output), buffer10, "wsnb10_flowacc5"),
    zone_in_shed(rast(flowacc3_output), buffer10, "wsnb10_flowacc3"),
    zone_in_shed(rast(flowacc1_output), buffer10, "wsnb10_flowacc1"),
    zone_in_shed(rast(slope10_output), buffer10, "wsnb10_slope10"),
    zone_in_shed(rast(slope5_output), buffer10, "wsnb10_slope5"),
    zone_in_shed(rast(slope3_output), buffer10, "wsnb10_slope3"),
    zone_in_shed(rast(slope1_output), buffer10, "wsnb10_slope1"),
    zone_in_shed(rast(tpi10_output), buffer10, "wsnb10_tpi10"),
    zone_in_shed(rast(tpi5_output), buffer10, "wsnb10_tpi5"),
    zone_in_shed(rast(tpi3_output), buffer10, "wsnb10_tpi3"),
    zone_in_shed(rast(tpi1_output), buffer10, "wsnb10_tpi1"),
    zone_in_shed(rast(twi10_output), buffer10, "wsnb10_twi10"),
    zone_in_shed(rast(twi5_output), buffer10, "wsnb10_twi5"),
    zone_in_shed(rast(twi3_output), buffer10, "wsnb10_twi3"),
    zone_in_shed(rast(twi1_output), buffer10, "wsnb10_twi1"),
    zone_in_shed(curve10_plan, buffer10, "wsnb10_curve10_plan"),
    zone_in_shed(curve10_prof, buffer10, "wsnb10_curve10_prof"),
    zone_in_shed(curve5_plan, buffer10, "wsnb10_curve5_plan"),
    zone_in_shed(curve5_prof, buffer10, "wsnb10_curve5_prof"),
    zone_in_shed(curve3_plan, buffer10, "wsnb10_curve3_plan"),
    zone_in_shed(curve3_prof, buffer10, "wsnb10_curve3_prof"),
    zone_in_shed(curve1_plan, buffer10, "wsnb10_curve1_plan"),
    zone_in_shed(curve1_prof, buffer10, "wsnb10_curve1_prof"),
    zone_in_shed(depth10, buffer10, "wsnb10_depth10"),
    zone_in_shed(depth5, buffer10, "wsnb10_depth5"),
    zone_in_shed(depth3, buffer10, "wsnb10_depth3"),
    zone_in_shed(depth1, buffer10, "wsnb10_depth1")

)
#### Buffer 20 ####
wsnb20 <- bind_cols(
    zone_in_shed(rast(flowacc10_output), buffer20, "wsnb20_flowacc10"),
    zone_in_shed(rast(flowacc5_output), buffer20, "wsnb20_flowacc5"),
    zone_in_shed(rast(flowacc3_output), buffer20, "wsnb20_flowacc3"),
    zone_in_shed(rast(flowacc1_output), buffer20, "wsnb20_flowacc1"),
    zone_in_shed(rast(slope10_output), buffer20, "wsnb20_slope10"),
    zone_in_shed(rast(slope5_output), buffer20, "wsnb20_slope5"),
    zone_in_shed(rast(slope3_output), buffer20, "wsnb20_slope3"),
    zone_in_shed(rast(slope1_output), buffer20, "wsnb20_slope1"),
    zone_in_shed(rast(tpi10_output), buffer20, "wsnb20_tpi10"),
    zone_in_shed(rast(tpi5_output), buffer20, "wsnb20_tpi5"),
    zone_in_shed(rast(tpi3_output), buffer20, "wsnb20_tpi3"),
    zone_in_shed(rast(tpi1_output), buffer20, "wsnb20_tpi1"),
    zone_in_shed(rast(twi10_output), buffer20, "wsnb20_twi10"),
    zone_in_shed(rast(twi5_output), buffer20, "wsnb20_twi5"),
    zone_in_shed(rast(twi3_output), buffer20, "wsnb20_twi3"),
    zone_in_shed(rast(twi1_output), buffer20, "wsnb20_twi1"),
    zone_in_shed(curve10_plan, buffer20, "wsnb20_curve10_plan"),
    zone_in_shed(curve10_prof, buffer20, "wsnb20_curve10_prof"),
    zone_in_shed(curve5_plan, buffer20, "wsnb20_curve5_plan"),
    zone_in_shed(curve5_prof, buffer20, "wsnb20_curve5_prof"),
    zone_in_shed(curve3_plan, buffer20, "wsnb20_curve3_plan"),
    zone_in_shed(curve3_prof, buffer20, "wsnb20_curve3_prof"),
    zone_in_shed(curve1_plan, buffer20, "wsnb20_curve1_plan"),
    zone_in_shed(curve1_prof, buffer20, "wsnb20_curve1_prof"),
    zone_in_shed(depth10, buffer20, "wsnb20_depth10"),
    zone_in_shed(depth5, buffer20, "wsnb20_depth5"),
    zone_in_shed(depth3, buffer20, "wsnb20_depth3"),
    zone_in_shed(depth1, buffer20, "wsnb20_depth1")

)
#### Buffer 100 ####
wsnb100 <- bind_cols(
    zone_in_shed(rast(flowacc10_output), buffer100, "wsnb100_flowacc10"),
    zone_in_shed(rast(flowacc5_output), buffer100, "wsnb100_flowacc5"),
    zone_in_shed(rast(flowacc3_output), buffer100, "wsnb100_flowacc3"),
    zone_in_shed(rast(flowacc1_output), buffer100, "wsnb100_flowacc1"),
    zone_in_shed(rast(slope10_output), buffer100, "wsnb100_slope10"),
    zone_in_shed(rast(slope5_output), buffer100, "wsnb100_slope5"),
    zone_in_shed(rast(slope3_output), buffer100, "wsnb100_slope3"),
    zone_in_shed(rast(slope1_output), buffer100, "wsnb100_slope1"),
    zone_in_shed(rast(tpi10_output), buffer100, "wsnb100_tpi10"),
    zone_in_shed(rast(tpi5_output), buffer100, "wsnb100_tpi5"),
    zone_in_shed(rast(tpi3_output), buffer100, "wsnb100_tpi3"),
    zone_in_shed(rast(tpi1_output), buffer100, "wsnb100_tpi1"),
    zone_in_shed(rast(twi10_output), buffer100, "wsnb100_twi10"),
    zone_in_shed(rast(twi5_output), buffer100, "wsnb100_twi5"),
    zone_in_shed(rast(twi3_output), buffer100, "wsnb100_twi3"),
    zone_in_shed(rast(twi1_output), buffer100, "wsnb100_twi1"),
    zone_in_shed(curve10_plan, buffer100, "wsnb100_curve10_plan"),
    zone_in_shed(curve10_prof, buffer100, "wsnb100_curve10_prof"),
    zone_in_shed(curve5_plan, buffer100, "wsnb100_curve5_plan"),
    zone_in_shed(curve5_prof, buffer100, "wsnb100_curve5_prof"),
    zone_in_shed(curve3_plan, buffer100, "wsnb100_curve3_plan"),
    zone_in_shed(curve3_prof, buffer100, "wsnb100_curve3_prof"),
    zone_in_shed(curve1_plan, buffer100, "wsnb100_curve1_plan"),
    zone_in_shed(curve1_prof, buffer100, "wsnb100_curve1_prof"),
    zone_in_shed(depth10, buffer100, "wsnb100_depth10"),
    zone_in_shed(depth5, buffer100, "wsnb100_depth5"),
    zone_in_shed(depth3, buffer100, "wsnb100_depth3"),
    zone_in_shed(depth1, buffer100, "wsnb100_depth1")

)
#### ####
all_wsnb <- bind_cols(wsnb1, wsnb10, wsnb20, wsnb100)
...
RFDef <- randomForest(point_valuespk ~ ., data = all_df)
RFDef
plot(RFDef)

RFDefImp <- randomForest(point_valuespk ~ ., data = all, importance = TRUE)
varImpPlot(RFDefImp, type = 1, scale = FALSE, n.var = ncol(all) - 1, cex = 0.8, main = "Variable importance")
varImpPlot(RFDefImp, type = 1, scale = FALSE, n.var = 10, cex = 0.8, main = "Variable importance")
...
varImpPlot(RFDefImp, type = 1, scale = FALSE, main = "Variable importance")
...
iris.vsurf <- VSURF(all_df[,-1], all_df[, 1])
